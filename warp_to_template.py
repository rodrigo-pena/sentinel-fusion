...
def main(source, template, output, resample_algorithm):
    ...
    # Save source and template to GeoTIFF as they will need to be read by GDAL
    ...
    warped = gu.resample_with_gdalwarp(temp_source_path,
                                       temp_template_path,
                                       resample_algorithm)
    ...
    for i, band in enumerate(bands):
        band['band_data'] = warped.GetRasterBand(i + 1).ReadAsArray()
