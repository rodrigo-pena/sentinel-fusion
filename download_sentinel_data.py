...
@click.command()
@click.option('--aoi_geojson', required=True,
...
def main(aoi_geojson,
    ...
    with open(os.path.join(download_path,
                           "sentinel_data_download_"+now+".txt"), "w") as fp:
